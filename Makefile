...
COMMONOBJS = open.o close.o errno.o read.o lseek.o bd.o alloc.o ufs.o
COMMONOBJS+= memcpy.o strcmp.o strlen.o ashrdi3.o bzero.o bcopy.o

STAGE1OBJS = bbstart.o main.o resource.o keyboard.o console.o
...
stage2: aout2bb stage2.out
	./aout2bb -S 28160 stage2.out $@ || nm -u stage2.out
