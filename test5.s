...
#
# It's a hello world program. It just writes "Hello, World!" on the screen,
# and locks up. It does mean that we have the Font Manager working, though...
#
...
#
# Now we play with QuickDraw a bit... (some code stolen from test3)
#
